...
#   AUTH0_DOMAIN_STAGING              -> TF_VAR_auth0_domain
#   AUTH0_CLIENT_ID_STAGING           -> TF_VAR_auth0_mgmt_client_id
#   AWS_ACCOUNT_ID_STAGING            -> TF_VAR_aws_account_id
#   AWS_REGION                      -> TF_VAR_aws_region
#
# From repository SECRETS (sensitive, masked in logs):
#   AUTH0_CLIENT_SECRET_STAGING       -> TF_VAR_auth0_mgmt_client_secret
#   SENDGRID_API_KEY_STAGING          -> TF_VAR_sendgrid_api_key
#   CIF_VALIDATION_API_SECRET_STAGING -> TF_VAR_cif_validation_api_secret
#
...
app_callback_urls = [
  "https://olb-staging.example.com/callback",
]

app_logout_urls = [
  "https://olb-staging.example.com",
]

support_portal_callback_urls = [
  "https://support-staging.example.com/callback",
]

cif_validation_api_url = "https://core-banking-staging.example.com/api/cif/validate"
